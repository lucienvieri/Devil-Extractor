/**
 * main.c — Devil Extractor CLI
 *
 * Usage:
 *   echo '<p>Hello</p>' | devil-cli
 *   devil-cli file1.html file2.html
 *
 * Reads HTML from stdin (default) or file arguments, outputs plain text to stdout.
 * Pipeline: searchngx | devil-cli | chat_agent
 */
...
/* Read stdin into a malloc'd buffer. Returns NULL on error. */
static uint8_t *
